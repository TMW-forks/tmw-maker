   ...
   private void initComponents() {
	...
	public static void main(String args[]) {
		try {
			...
			java.util.logging.Logger.getLogger(FrmTMWMaker2.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			...
			@Override
			public void run() {
				FrmTMWMaker2 frmTMWMaker2 = new FrmTMWMaker2();
				frmTMWMaker2.setExtendedState(MAXIMIZED_BOTH);
				frmTMWMaker2.setVisible(true);
			}
		});
		/*java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
