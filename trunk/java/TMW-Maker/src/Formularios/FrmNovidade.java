...
public class FrmNovidade extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        TxpNovidades.setFont(new java.awt.Font("Verdana", 0, 12));
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        String Conteudo = FileClass.urlAbrir(Endereco);
        TxpNovidades.setText(StringClass.ISO88591toUTF8(Conteudo));
