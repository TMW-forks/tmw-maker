...
public class FrmScript extends javax.swing.JDialog {
            ...
            for (int p = 0; p < Pasta.length; p++) {
                if (!Pasta[p].equals(".svn") && !Pasta[p].equals("functions")) {
                    ...
                    for (int a = 0; a < Arquivo.length; a++) {
                        if (!Arquivo[a].substring(Arquivo[a].toString().length() - 1, Arquivo[a].toString().length()).equals("~")
    ...
    private void initComponents() {
        ...
        TreScripts.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                TreScriptsMouseClicked(evt);
            }
        });
    ...
    private void MnuScriptAbrirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnuScriptAbrirActionPerformed
        ...
        if (TreScripts.getLeadSelectionPath().getPathCount() == 4
    ...
    private void MnuNovaLojistaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnuNovaLojistaActionPerformed
        if (TreScripts.getLeadSelectionPath().getPathCount() == 3
                                ...
                                if (FileClass.arquivoSalvar(
                                    ...
                                    try {
                                        ...
                                        DialogClass.showErro("<html>"
                                                ...
                                                + " * <font color=\"#FF0000\"><b>" + Comando + "</b></font>!", "ERRO");
                                    }
    ...
    private void TreScriptsMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TreScriptsMouseClicked

        if (evt.getClickCount() == 2) {
            javax.swing.JDialog frmJanela = null;
            if (TreScripts.getLeadSelectionPath().getPathComponent(2).toString().endsWith(".conf")
                    || TreScripts.getLeadSelectionPath().getPathComponent(2).toString().endsWith(".xml")
                    || TreScripts.getLeadSelectionPath().getPathComponent(3).toString().endsWith(".xml")
                    || TreScripts.getLeadSelectionPath().getPathComponent(3).toString().endsWith(".conf")
                    ||TreScripts.getLeadSelectionPath().getPathComponent(2).toString().endsWith(".txt")) {
                if (TreScripts.getLeadSelectionPath().getPathCount() == 4
                        && TreScripts.getLeadSelectionPath().getPathComponent(3).toString().equals("_shops.txt")) {
                    frmJanela = new FrmLojas(this, rootPaneCheckingEnabled);
                } else {
    ...
    }//GEN-LAST:event_TreScriptsMouseClicked
