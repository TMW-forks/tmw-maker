...
public class SpriteXML {
    ...
    private static String TMWData=FrmSpawnEditor.pastaDoLocalhost+Barra+"tmwdata";
    ...
    private XmlAcao Banco_Acoes[]; //N�o deve ser instaciado agora!!!!
...
//#################################################################################################
    ...
    public class XmlAcao {
        ...
        private XmlAnimacao Banco_Animacoes[]; //N�o deve ser instaciado agora!!!!
        ...
        public class XmlAnimacao {
            ...
            private String Banco_Nome="";
            private XmlFrame Banco_Frames[]; //N�o deve ser instaciado agora!!!!
